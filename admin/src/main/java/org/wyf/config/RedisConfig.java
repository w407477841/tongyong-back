...
import org.wyf.cache.CacheTemplateService;
import org.wyf.cache.RedisUtil;
import org.wyf.config.properties.JedisProperties;
...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    @Bean
    public RedissonClient redissonClient(JedisProperties jedisProperties){
        Config config = new Config();
        config.useSingleServer().setAddress("redis://"+jedisProperties.getHost()+":"+jedisProperties.getPort());
        if(StrUtil.isNotBlank(jedisProperties.getPassword())){
            config.useSingleServer().setPassword(jedisProperties.getPassword());
        }
...
//        template.setStringSerializer( new StringRedisSerializer());
    ...
    public CacheTemplateService cacheTemplateService(RedisUtil redisUtil){
        return new CacheTemplateService(redisUtil);
    }
