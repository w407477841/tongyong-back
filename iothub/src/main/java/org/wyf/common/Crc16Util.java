...
public class Crc16Util {
     ...
     * @return
     */
    protected static byte[] getData(String... strings) {
        byte[] data = new byte[]{};
     ...
     * @return
     */
    protected static byte[] getData(byte[] aa) {
        byte[] bb = getCrc16(aa);
     ...
     */
    protected static byte[] getCrc16(byte[] arr_buff) {
     ...
     * 将字节数组转换成十六进制字符串
     */
    protected static String byteTo16String(byte[] data) {
     ...
     * [-128,-1],0,[1,128)
     */
    protected static String byteTo16String(byte b) {
        StringBuffer buffer = new StringBuffer();
        int aa = (int) b;
        if (aa < 0) {
